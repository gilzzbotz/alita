...
module.exports = {
	...
	alias: ["tebakalimat"],
	category: "game",
	desc: "Game untuk menebak lanjutkan dari kalimat soal",
	isSpam: true,
	isGroup: true,
	isLimitGame: true,
	async run({ msg, conn }, { q, map }) {
		...
		let ambil = await (await fetch('https://raw.githubusercontent.com/mrfzvx12/random-scraper/main/game/tebakkalimat.json')).json()
