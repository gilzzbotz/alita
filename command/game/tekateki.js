...
module.exports = {
	...
	alias: ["tekateki"],
	category: "game",
	desc: "Game untuk menebak dari teka teki yang diberikan",
	isSpam: true,
	isGroup: true,
	isLimitGame: true,
	async run({ msg, conn }, { q, map }) {
		...
		let ambil = await (await fetch('https://raw.githubusercontent.com/mrfzvx12/random-scraper/main/game/tekateki.json')).json()
