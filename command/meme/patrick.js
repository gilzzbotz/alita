...
module.exports = {
	...
	async run({ msg, conn }, { q }) {
		...
		conn.sendFile(msg.from, 'https://rest-beni.herokuapp.com/api/canvas/patrick?image=' + hasil + '&apikey=' + apikey, '', '', msg)
		} else {
			msg.reply('Kirim atau reply gambar dengan caption crush')
		}
	},
};
